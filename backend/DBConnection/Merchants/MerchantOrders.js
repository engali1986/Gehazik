...
const MerchantOrders=async(MerchantID)=>{
    try {
        ...
        .db("Gehazik")
        .collection("Orders")
        .find({'OrderedItems.MerchantID': MerchantID.toString()},{projection:{OrderedBy:1,OrderedDate:1, OrderedPaymentMethod:1,OrderedItems:1,OrderDelivered:1,OrderPayed:1,OrderPaymentDate:1,MerchantPaymentSent:1, MerchantPaymentDate:1, OrderCompleted:1,OrderStatus:1}}).toArray()
