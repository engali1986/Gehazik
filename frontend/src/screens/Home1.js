  ...
  return (
    <Container>
        ...
        >
          ...
          >
            <div
              onClick={(e) => {
                e.stopPropagation();
                if ( params.BackDropRef.current.classList.contains("BackDropActivated")) {
          ...
          params.BackDropRef.current.classList.remove("BackDropActivated");
      ...
      <Row className=" d-md-none  d-flex" style={{ backgroundColor: "gray" }}>
        ...
        <Col
          className=" d-flex SmallMenu"
          style={{ fontSize: "1rem", maxWidth: "fit-content", alignContent:'center',alignItems:'center' }}
          onClick={(e)=>{
            if (params.BackDropRef.current.classList.contains("BackDropActivated")) {
        ...
        <Col
          ...
          style={{ fontSize: "1rem", maxWidth: "fit-content" }}
        >
          <Link to="/LogIn">LogIn</Link>
        </Col>
      </Row>
